...
const viatSol: DataSet = {
  ...
  rows: [
    ...
    { codigo: "VIA-2026-074", solicitante: "J. Fernández", destino: "Caracas", ida: "2026-05-11", regreso: "2026-05-14", monto: 850, estatus: "Pendiente", etapa: "Solicitud" },
  ],
};
...
export const datasets: Record<string, DataSet> = {
  ...
  "/app/tesoreria/caja-chica": cajaMov,
  ...
  "/app/tesoreria/viaticos": viatSol,
